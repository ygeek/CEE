INSERT INTO api_map(`id`, `name`, `desc`, `longitude`, `latitude`, `geohash`, `image_key`, `city_id`) VALUES
...
INSERT INTO api_choice(`id`, `order`, `name`, `desc`, `image_key`, `answer`, `task_id`) VALUES
(1, 1, 'Choice-1', 'Choice-Desc-1', 'choice-1.png', 2, 1);
INSERT INTO api_option(`id`, `order`, `desc`, `choice_id`) VALUES
(1, 1, 'Option-Desc-1', 1),
(2, 2, 'Option-Desc-2', 1);
INSERT INTO api_story(`id`, `name`, `desc`, `time`, `good`, `distance`, `coin`, `image_keys`, `tour_img_key`, `city_id`) VALUES
(1, 'Story-1', 'Story-Desc-1', 45, 213, 5.1, 120, '["story-1-1.png", "story-1-2.png"]', 'story-tour-1.png', '300210000'),
(2, 'Story-2', 'Story-Desc-2', 12, 23, 8.3, 130, '["story-2-1.png"]', 'story-tour-2.png', '300210000');
